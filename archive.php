      ...
      if ($terms) : ?>
        <ul class="works-hero__list">
          ...
          foreach ($terms as $term) :
            $active_class = ($current_category_id == $term->term_id) ? 'active' : ''; ?>
            <li class="works-hero__item <?php echo $active_class; ?>">
...
<section class="section case">
  ...
  if ($terms) :
    foreach ($terms as $term) :
      if ($term->term_id == $current_category_id) : ?>
        <div class="case-category">
          <div class="case-category__title title-4 <?php echo ($current_category_id == $term->term_id) ? 'active' : ''; ?>">
