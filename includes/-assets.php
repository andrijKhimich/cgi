...
function my_assets(): void {
	...
	if (is_single()) {
		...
		wp_enqueue_script('vimeo-jquery-api', $stylesheet_directory_uri . '/libs/js/vimeo-jquery-api.js', array('jquery'), filemtime(get_stylesheet_directory() . '/libs/js/vimeo-jquery-api.js'), true);
		wp_enqueue_script('magnific-popup-api', $stylesheet_directory_uri . '/libs/js/vimeo-api.js', array('jquery'), filemtime(get_stylesheet_directory() . '/libs/js/vimeo-api.js'), true);
